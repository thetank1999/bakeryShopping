        ...
        <jsp:include page="Menu.jsp"></jsp:include>
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-12" style="border-bottom: 0.5rem solid #007bff; padding-top: 1.3%;">
                            <ul style="list-style: none;">
                                ...
                                <li style="display: inline; padding: 1.6rem 0.9rem; background-color: #007bff;"><a href="getCompletedOrder" style="font-size: 1.2rem; color: white;">Completed Order</a></li>
                    ...
                    <h1 class="display-4 my-4 text-info" style="text-align: center;">Completed Order</h1>
                    <c:set var="result" value="${requestScope.COMPLETED_ORDER}" />
                            ...
                            <table class="table table-striped" id="data" style="width: 100%; border-collapse: collapse">
                                <thead>
                                    <tr class="list-header">
                                        ...
                                        <th scope="col">Sale in charge</th>
