                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-12" style="border-bottom: 0.5rem solid #007bff; padding-top: 1.3%;">
                            <ul style="list-style: none;">
                                ...
                                <li style="display: inline; padding: 1.6rem 0.9rem; background-color: #007bff;"><a href="getCancelOrder" style="font-size: 1.2rem; color: white;">Cancel Order</a></li>
                            </ul>
                        </div>

                        <p class="text-danger">${requestScope.ASSIGNED_ORDER_LIMIT_REACH_ERROR}</p>
                    <h1 class="display-4 my-4 text-info" style="text-align: center;">Cancel Order</h1>
                    <c:set var="result" value="${requestScope.CANCEL_ORDER}" />
