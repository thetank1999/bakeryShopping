                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-12" style="border-bottom: 0.5rem solid #007bff; padding-top: 1.3%;">
                            <ul style="list-style: none;">
                                ...
                                <li style="display: inline; padding: 1.6rem 0.9rem; background-color: #007bff; "><a href="getAssignedOrder?currentPage=deliver" style="font-size: 1.2rem; color: white;">Deliver Order</a></li>
                                ...
                                <form action="getOrderDetail">
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <div class="line"><fmt:formatNumber type="number" maxFractionDigits="0" value="${dtod.totalPrice}" /> VND</div>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="link" style="padding-top: 2%;">
                                                <c:url var="updateLink" value="setOrderStatus">
                                                    ...
                                                    <c:param name="currentPage" value="deliver" />
                                                </c:url>
                                                <a class="update-link" href="${updateLink}" style="display: compact;">Finish</a>
